...
def test_advanced_nlp_action_extraction_simple():
    ...
    segs = [
        TranscriptSegment(speaker_id="SPEAKER_01", start=0.0, end=3.0, text="Budi akan menyiapkan laporan minggu depan."),
        TranscriptSegment(speaker_id="SPEAKER_02", start=3.0, end=6.0, text="Baik, itu akan diselesaikan.")
    ]
...
def test_decision_extraction_keywords():
    ...
    sentences = ["Kita sepakat untuk menunda acara hingga bulan depan.", "Tidak ada keputusan tambahan."]
